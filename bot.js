...
bot.on("ready", () => {
    ...
    bot.user.setActivity(`AlexanderTV#7584`);

    bot.on('message',msg=>{

        if ( msg.content === "!who"){
    
            msg.reply ( 'Hi Guys im Slayers Bot Coded By AlexanderTV#7584');
        }
    
    });
    bot.on('message',msg=>{

        if ( msg.content === "!malik"){
    
            msg.reply ( 'Llah ibark f3mr sidi AlexanderTV#7584');
        }
    ...
    bot.on('message',msg=>{
        ...
        if ( msg.content === "!friend"){
            ...
            msg.reply ( 'Friends  : EasyAntiCheats#9723 && Vexy#9629');
        }
...
bot.on("message", async message => {
    ...
    if(command === 'hello') {
        message.reply(' Mkayn la hello la zebbi ');
    }
    ...
    if(command === 'kick') {
        ...
        message.reply(`User kicked By Alexander™ !`);
    }
    ...
    if(command === 'ban') {
        ...
        message.reply(`User banned By Alexander™ !`);
    }
